...
RUN set -o allexport \
    ...
    && apk --no-cache add --virtual .build-base g++ musl-dev py3-numpy-dev py3-yaml py3-scipy py3-pandas build-base linux-headers python3-dev git cmake jpeg-dev bash libffi-dev gfortran openblas-dev openmp-dev openmpi-dev numactl-dev freetype-dev libpng-dev \
